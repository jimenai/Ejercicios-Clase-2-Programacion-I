...
void empleadoPorAnio(eEmpleado vec[], int tam, int anio);
...
int main()
{
    ...
    do
    {
        ...
        case 6:
            ...
            printf("Ingrese anio:");
            scanf("%d", &anio);
            empleadoPorAnio(lista, TAM, anio);
            system("pause");
            break;
...
void altaEmpleado(eEmpleado vec[], int tam)
{
    ...
    else
    {
        ...
        if( esta == -1)
        {
            ...
            scanf("%02d/%02d/%d", &vec[indice].fechaIngreso.dia,&vec[indice].fechaIngreso.mes,&vec[indice].fechaIngreso.anio );
...
void empleadoPorAnio(eEmpleado vec[], int tam, int anio){
    ...
    if(cont == 0)
    {
        printf("No hay empleados en el año ingresado: %d\n\n", anio);
    }
}
